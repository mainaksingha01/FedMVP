...
_C.MODEL.N_CTX = 3 # number of context vectors
...
# _C.GOPTIM.NAME = "sgd"
# _C.GOPTIM.LR = 0.0001
# _C.GOPTIM.WEIGHT_DECAY = 1e-5
# _C.GOPTIM.MOMENTUM = 0.9

# # Learning rate scheduler
# _C.GOPTIM.LR_SCHEDULER = "cosine"
# # -G1 or 0 means the stepsize is equal to max_epoch
# _C.GOPTIM.STEPSIZE = (-1, )
# _C.GOPTIM.GAMMA = 0.1
# _C.GOPTIM.MAX_EPOCH = 1000
